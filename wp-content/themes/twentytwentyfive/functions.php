...
add_action('rest_api_init', function () {
    register_rest_route('custom/v1', '/my-courses', [
        'methods' => 'GET',
        'callback' => 'get_tutor_user_courses',
        'permission_callback' => function () {
            return is_user_logged_in(); // works if using cookies
            // or return current_user_can('read'); // JWT support
        }
    ]);
});

function get_tutor_user_courses(WP_REST_Request $request) {
